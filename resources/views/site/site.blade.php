...
@section('content')
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="SiteCards__bgimage  text-white d-grid card-img" style="background-image: url('{{ asset('build/images/site/BANNER-HOME-TOPO.png') }}');">
    ...
    <!-- {{-- cards iniciais --}} -->
    <!-- teste SiteCards__bgimage
<div class="card  col-sm-6 col-md">
<div class="SiteCards__bgimage  text-white d-grid" style="background-image: url('{{ asset('build/images/site/DESTAQUES-HOME-REDE-600-x-600-px.png') }}');">
