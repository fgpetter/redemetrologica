...
<div class="card text-bg-dark">
    ...
    <div class="card-img-overlay d-flex justify-content-center">
        <div class="align-self-center text-center SiteBanner--text">
            <h1 class="text-warning ">REDE METROLÓGICA RS</h1>
            <h4 class="text-white">Certificada ABNT NBR ISO 9001 pela DNV</h4>
            <h4 class="text-white">Acreditada ABNT NBR ISO/IEC 17043 pela Cgcre - PEP 0002</h4>
        </div>
    </div>
