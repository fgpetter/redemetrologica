...
<body>
    ...
    <!-- footer -->
    <footer>
        <div class=" mt-5 pt5 mb-5 pb-5 bg-image  text-white position relative" style="background-image: url('{{ asset('build/images/site/banner-footer.png') }}');">
            <div class="d-flex justify-content-center">
            ...
            <div class="d-flex justify-content-center align-items-center footer__rodape position-absolute bottom-0 ">
