        ...
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{ asset('build\images\site\BANNER-CURSOS-DESTAQUE-2_B.png') }}" class="card-img"
                        alt="...">
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('build\images\site\BANNER-CURSOS-DESTAQUE-3_B-1.png') }}" class="card-img"
                        alt="...">
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('build\images\site\BANNER-CURSOS-DESTAQUE-1_B.png') }}" class="card-img"
                        alt="...">
                </div>
            </div>
