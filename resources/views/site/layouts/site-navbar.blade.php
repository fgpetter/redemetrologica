    ...
    <div class="row">
        <div class="col-6">
            ...
            <a class="navbar-brand " href="#">
                <img src="{{ asset('build\images\site\LOGO_REDE_COLOR.png') }}" alt="Rede Metrológica RS" width="238"
                    height="115">
            </a>
        </div>
        <div class="col-6 d-flex justify-content-end ">
            ...
            <div class="collapse navbar-collapse  	text--bs-primary-text-emphasis" id="navbarSupportedContent">
