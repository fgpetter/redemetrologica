        ...
        <div class="col-6">
          ...
          <select class="form-select" name="pessoa_id" aria-label="Default select example">
            ...
            @foreach ($pessoas as $pessoa)
              <option @selected($lancamento->pessoa_id == $pessoa->id) value="{{$pessoa->id}}">{{$pessoa->nome_razao}}</option>
            @endforeach
          </select>
          @error('pessoa')
            <div class="text-warning">{{ $message }}</div>
        ...
        <div class="col-6">
          ...
          <select class="form-select" name="centro_custo_id" aria-label="Default select example">
            ...
            @foreach ($centrosdecusto as $centrodecusto)
              <option @selected($lancamento->centro_custo_id == $centrodecusto->id) value="{{$centrodecusto->id}}">{{$centrodecusto->descricao}}</option>
            @endforeach
          </select>
