<div class="row">
    <div class="col-12">
        <a href="#" class="btn btn-sm btn-success float-end" data-bs-toggle="modal" data-bs-target="#qualificacaoModal">
    ...
    <table class="table table-responsive table-striped align-middle table-nowrap mb-0">
      ...
      <tbody>
        @forelse ($qualificacoes as $qualificacao)
          <tr>
            <th>
              <a href="#" data-bs-toggle="modal" data-bs-target="{{'#qualificacaoModal'.$qualificacao->uid}}">#{{substr($qualificacao->uid, 7)}} </a>
            </th>
            ...
            <td>
              <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink2">
                  ...
                  <li>
                    <form method="POST"
                      action="{{ route('area-atuacao-delete', $qualificacao['uid']) }}">
                      @csrf
