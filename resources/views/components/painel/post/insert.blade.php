            ...
            <div class="tab-pane active" id="post" role="tabpanel">
                <form method="POST" enctype="multipart/form-data"
                  ...
                  {!! old('conteudo') ?? ($post->conteudo ?? null) !!}
                        ...
                        {{-- fotos da galeria --}}
                        <div class="col-12">
                            <label class="form-label">Inserir Imagens</label>
                                ...
                                <div class="d-flex flex-wrap mt-3">
                                    @foreach ($postMedia as $media)
                                        <div class="card border m-2" style="width: 11rem; height: 11rem">
                                            <div class="card-body"
                                                style="background-image: url('{{ asset($media->caminho_media) }}'); background-size: cover;">
                                                <a href="javascript:void(0)" class="btn btn-danger btn-sm"
                                                    onclick="document.getElementById('imagem-delete-{{ $loop->index }}').submit();">
                                                    <strong>X</strong></a>
                                            </div>
                                        </div>
                                    @endforeach
