<form method="POST"
  ...
  <div class="row mt-3"> 
    ...
    <div class="col-md-3">
      <x-forms.input-field :value="old('data_limite_inscricao') ?? ($agendainterlab->data_limite_inscricao?->format('Y-m-d') ?? null)" type="date" name="data_limite_inscricao" label="Limite inscrição" />
    </div>
    <div class="col-md-3">
      <x-forms.input-field :value="old('data_limite_envio_ensaios') ?? ($agendainterlab->data_limite_envio_ensaios?->format('Y-m-d') ?? null)" type="date" name="data_limite_envio_ensaios" label="Limite Envio ensaios" />
    </div>
  </div>
  <div class="row mt-3"> 
    <div class="col-md-3">
    ...
    <div class="col-md-3">
      <x-forms.input-field :value="old('data_limite_envio_resultados') ?? ($agendainterlab->data_limite_envio_resultados?->format('Y-m-d') ?? null)" type="date" name="data_limite_envio_resultados" label="Envio resultados" />
    </div>
    <div class="col-md-3">
      <x-forms.input-field :value="old('data_divulgacao_relatorios') ?? ($agendainterlab->data_divulgacao_relatorios?->format('Y-m-d') ?? null)" type="date" name="data_divulgacao_relatorios" label="Divulgação relatórios" />
    </div>
  </div>
