      ...
      <table class="table table-responsive table-striped align-middle table-nowrap mb-0">
        <thead>
          <tr>
            <th scope="col"></th>
            <th scope="col">
              <input type="text" class="form-control form-control-sm" onkeypress="search(event, window.location.href, 'buscanome')" placeholder="Buscar por nome" value="{{ $busca_nome ?? null }}">
            </th>
            <th scope="col">
              <input type="text" class="form-control form-control-sm" onkeypress="search(event, window.location.href, 'buscadoc')" placeholder="Buscar por documento" value="{{ $busca_doc ?? null }}">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-truncate" style="max-width: 50vw">
            ...
            <td>
              <div class="dropdown">
                <a href="#" role="button" id="dropdownMenuLink1" data-bs-toggle="dropdown" aria-expanded="false">
                  <i class="ph-dots-three-outline-vertical" style="font-size: 1.5rem" data-bs-toggle="tooltip" data-bs-placement="top" title="Detalhes e edição"></i>
                </a>
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                  <li><a class="dropdown-item" href="{{ route('pessoa-insert', ['pessoa' => $pessoa->uid]) }}">Editar</a>
                  </li>
                  <li>
                    <x-painel.form-delete.delete route='pessoa-delete' id="{{ $pessoa->uid }}" />
                  </li>
                </ul>
              </div>
