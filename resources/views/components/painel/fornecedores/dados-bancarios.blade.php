     <div class="card">
         ...
         <div class="card-body">
             ...
             <ul class="list-group list-group-flush">
                 @forelse ($fornecedor->pessoa->dadosBancarios as $conta)
                     <x-painel.fornecedores.modal-dados-bancarios :fornecedor="$fornecedor" :conta="$conta" />
     ...
     <x-painel.fornecedores.modal-dados-bancarios :conta="null" :fornecedor="$fornecedor" />
