    ...
    <div class="row">
      <div class="col-12">
        <div class="hstack gap-2 flex-wrap mb-3 justify-content-end">
          <a href="#" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#cursoshabilitadosModal">
    ...
    <div class="table-responsive" style="min-height: 25vh">
      <table class="table table-responsive table-striped align-middle table-nowrap mb-0">
        ...
        <tbody>
          ...
          <tr>
            <th>
              <a href="#" data-bs-toggle="modal" data-bs-target="{{'#cursoshabilitadosModal'.$cursohabilitado->uid}}">
            ...
            <td>
              <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink2">
                  ...
                  <li>
                    <x-painel.form-delete.delete route='instrutor-delete-curso-habilitado' id="{{ $cursohabilitado->uid }}" />
                  </li>
                </ul>
              </div>
            </td>
          </tr>
          <x-painel.instrutores.modal-cursos-habilitados :curso="$cursohabilitado->curso" :instrutor="$instrutor" :cursohabilitado="$cursohabilitado" />
          @empty
          <tr>
