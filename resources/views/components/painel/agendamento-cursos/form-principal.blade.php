             ...
             <div class="card border">
                 ...
                 <div class="card-body">
                     <div class="row gy-3">
                         ...
                         <div class="col-sm-3">
                             <x-forms.input-field :value="old('contato_email') ?? ($agendacurso->contato_email ?? null)" name="contato_email" label="E-mail" />
                             @error('contato_email')
                                 <div class="text-warning">{{ $message }}</div>
                             @enderror
                         </div>
                         ...
                         <div class="col-sm-3">
                             <x-forms.input-field :value="old('contato_telefone') ?? ($agendacurso->contato_telefone ?? null)" name="contato_telefone" label="Telefone" />
                         ...
                         <div class="col-sm-3">
                             <x-forms.input-field :value="old('num_participantes') ?? ($agendacurso->num_participantes ?? null)" name="num_participantes"
                         ...
                         <div class="col-sm-3">
                             <x-forms.input-field :value="old('validade_proposta') ?? ($agendacurso->validade_proposta ?? null)" type="date" name="validade_proposta"
                         ...
                         <div class="col-sm-3">
                             <x-forms.input-field :value="old('valor_orcamento') ?? ($agendacurso->valor_orcamento ?? null)" name="valor_orcamento" label="Valor do orçamento"
                                 class="money" />
