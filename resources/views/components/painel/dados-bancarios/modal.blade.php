...
<div class="modal fade" id="{{ ($index) ? " modal_conta_$index" : "modal_conta_cadastro" }}" tabindex="-1"
    aria-labelledby="{{ ($index) ? " modalgridConta$index" : "modalgridConta" }}" aria-modal="true">
    <div class="modal-dialog modal-dialog-right modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="{{ ($index) ? " modalgridConta$index" : "modalgridConta" }}">
                    {{$conta->conta ?? 'Cadastrar Conta'}}
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{ isset($conta->uid) ? route('conta-update', $conta->uid) : route('conta-create') }}"
                    method="POST">
                    @csrf
                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-sm-6">
                            <label class="form-label">Nome do banco<small class="text-danger-emphasis opacity-75">
                        ...
                        <div class="col-sm-6">
                            <label class="form-label">Código do banco<small class="text-danger-emphasis opacity-75">
                                    (Obrigatório) </small></label>
                        ...
                        <div class="col-sm-6">
                            <label class="form-label">Agencia<small class="text-danger-emphasis opacity-75">
                                    (Obrigatório) </small></label>
                        ...
                        <div class="col-sm-6">
                            <label class="form-label">Conta<small class="text-danger-emphasis opacity-75"> (Obrigatório)
                                </small></label>
