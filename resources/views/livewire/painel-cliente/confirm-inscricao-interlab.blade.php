<div>
    ...
    <!-- Listagem de inscrições existentes -->
                            ...
                            <form wire:submit.prevent="salvarEmpresa">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" wire:model="nome_razao" class="form-control">
                                        @error('nome_razao')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" wire:model="cpf_cnpj" class="form-control" readonly>
                                        @error('cpf_cnpj')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <label for="emailNF" class="form-label">Email NF</label>
                                        <input type="email" wire:model="emailNF" class="form-control">
                                        @error('emailNF')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row my-3 gy-2">
                                                            ...
                                                            <div class="col-12 col-sm-8">
                                                                <x-forms.input-field wire:model="endereco"
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <x-forms.input-field wire:model="bairro"
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <x-forms.input-field wire:model="cidade"
                                                            ...
                                                            <div class="col-4 col-sm-2">
                                                                <label for="uf"
                                                                    class="form-label mb-0">UF</label>
                            ...
                            @if ($novaInscricaoEmpresaId === $empresa->id)
                                <div class="mt-3 border-top pt-3">
                                    <form wire:submit.prevent="InscreveLab" id="confirma-inscricao-interlab"
                                        class="mt-4">
                                        <input type="hidden" wire:model="encerra_cadastro">
                                        <input type="hidden" wire:model="interlab_uid"
                                            value="{{ $interlab->uid ?? '' }}">
                                                ...
                                                <div class="row my-3 gy-2">
                                                    ...
                                                    <div class="col-4 col-sm-2">
                                                        ...
                                                        <input type="text" class="form-control" wire:model="uf"
                                                            ...
                                                            wire:keydown="this.value = this.value.toUpperCase()">
                                                        @error('uf')
                                                            <div class="text-warning">{{ $message }}</div>
                                                        @enderror
                                                    </div>
    ...
    <div class="row justify-content-center mb-5">
        <div class="col-md-6">
            <label for="cnpj" class="fw-bold">
                {{ $pessoa ? 'Inscreva outro CNPJ para cobrança' : 'Digite o CNPJ para cobrança' }}
            </label>
    ...
    @if ($showSalvarEmpresa)
        <form wire:submit.prevent="salvarEmpresa" class="mt-4">
            <div class="card border overflow-hidden card-border-dark shadow-none">
                ...
                <!-- Cabeçalho do Card -->
                <div class="card-header">
                    <h6 class="card-title mb-0">Informe os dados da Empresa</h6>
                </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <!-- Email de NF -->
                        <div class="col-md-6">
                            <label for="emailNF" class="form-label">Email de NF</label>
                            <input type="email" id="emailNF" wire:model="emailNF" class="form-control">
                            @error('emailNF')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-md-auto">
                            <button type="submit" class="btn btn-success">
                                {{ $empresa ? 'Atualizar Empresa' : 'Cadastrar Empresa' }}
                            </button>
                        </div>
                    </div>
                </div>
    ...
    @if ($showInscreveLab)
        <form wire:submit.prevent="InscreveLab" id="confirma-inscricao-interlab" class="mt-4">
            <input type="hidden" wire:model="encerra_cadastro">
            <input type="hidden" wire:model="interlab_uid" value="{{ $interlab->uid ?? '' }}">
