...
**Local environment:** PHP and MySQL run directly on the host. Do **not** use Laravel Sail (`vendor/bin/sail`) or Docker for Artisan, tests, Composer, or app commands — use `php artisan`, `composer`, and `php artisan test` on the host.
