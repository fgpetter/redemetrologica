...
return [
    ...
    | components. The default is the resources/views/components directory, but
    | you may customize this value under the component_locations key below.
    |
    */
    ...
    |---------------------------------------------------------------------------
    |
    | This value sets default namespaces that'll be used to resolve view-based
    | components with a namespace instead of needing to use their full path.
    |
    */
