...
use App\Http\Controllers\AgendaCursoInCompanyController;
...
Route::prefix('painel')->middleware('auth')->group(function () {
    ...
    Route::group(['prefix' => 'inscricao-curso'], function () {
        ...
        Route::put('salvar-inscrito/{inscrito:uid}', [InscricaoCursoController::class, 'atualizaInscrito'])->name('atualizar-inscrito');
    });
    ...
    Route::group(['prefix' => 'financeiro', 'middleware' => 'permission:funcionario,admin'], function () {
        ...
        Route::post('lancamento/batch-update', [LancamentoFinanceiroController::class, 'batchUpdate'])->name('lancamento-financeiro-batch-update');
