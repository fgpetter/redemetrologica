...
class ConfirmacaoInscricaoAnalistaNotification extends Mailable implements ShouldQueue
{
    ...
    public function __construct(InterlabAnalista $analista, InterlabInscrito $inscrito, AgendaInterlab $agenda_interlab)
    {
        $this->dados_email = [
            'interlab_nome' => $agenda_interlab->interlab->nome,
            'nome_da_pessoa' => $analista->nome,
